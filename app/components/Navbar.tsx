...
export default function Navbar() {
  return (
    <div className="fixed overflow-hidden shadow-[inset_0px_0px_24px_rgba(255,255,255,0.1)] top-0 w-[90%] rounded-2xl my-2 z-100 bg-neutral-800/60 backdrop-blur-3xl  h-fit px-6 py-4  flex justify-between items-center ">
      ...
      <div className="flex gap-6 items-center">
        <div className="flex gap-5">
          {navbarConstants.links.map((link, index) => {
            return (
              <div className="font-light" key={index + link.name}>
                {link.name}
              </div>
            );
          })}
