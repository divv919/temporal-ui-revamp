...
export default function Dashboard() {
  ...
  return (
    <div className="selection:!text-black selection:bg-neutral-50  p-2 lg:p-3 bg-linear-90 from-neutral-950/5 via-neutral-50/15  to-neutral-950/5  backdrop-blur-3xl  shadow-[inset_0px_0px_5px_rgba(255,255,255,0.2)] relative  mx-auto h-170  rounded-[36px] w-full lg:w-250 overflow-hidden">
      {/* Gradient */}
